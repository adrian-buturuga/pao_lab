package ro.unibuc.pao.sample.service;

import ro.unibuc.pao.sample.domain.Entity1;
import ro.unibuc.pao.sample.exceptions.InvalidDataException;
import ro.unibuc.pao.sample.persistence.Entity1Repository;
...
public class AwesomeService {
    ...
    /** services will have a way of obtaining backing repositories. One service can use multiple (or no) repositories. */
